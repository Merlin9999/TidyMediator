...
{
    public class NotificationRegistry : IDisposable
    {
        ...
        public virtual NotificationRegistry Subscribe<TNotification>(Action<TNotification> notificationAction)
        ...
        public virtual NotificationRegistry Subscribe<TNotification>(Func<TNotification, Task> notificationFunc)
            where TNotification : INotification
        {
            lock (this.LockObject)
            {
        ...
        public virtual NotificationRegistry Unsubscribe<TNotification>()
            where TNotification : INotification
        {
            lock (this.LockObject)
            {
        ...
        public virtual NotificationRegistry UnsubscribeAll()
        {
            lock (this.LockObject)
            {
