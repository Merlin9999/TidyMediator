...
namespace TidyMediator
{
    ...
    /// handlers are delegates attached to objects that are NOT maintained by the DI container and the handlers
    /// must be called within a synchronization context. Commonly, this is used to schedule notification handlers
    /// on a UI thread associated with a synchronization context.
    /// </summary>
